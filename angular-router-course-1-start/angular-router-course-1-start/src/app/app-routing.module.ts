...
@NgModule({
  imports: [
    RouterModule.forRoot(routes, {preloadingStrategy: CustomPreloadingStrategy,
                                  ...
                                  }) //enableTracing: true // paramsInheritanceStrategy:'always' //relativeLinkResolution: 'corrected'
                                  //malformedUriErrorHandler: (error:URIError, urlSerializer:UrlSerialized)=> urlSerializer.parse('/page-not-found')
  ],
